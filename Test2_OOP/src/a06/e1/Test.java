...
public class Test {
	...
	@org.junit.Before
	public void init() {
		this.factory = new FluentParserFactoryImplDiff();
	}
	...
	public void testRepetitiveIncrementingNaturals() {
		...
		assertThrows(IllegalStateException.class, ()->outParser.accept(3));//se da un'eccezione allora è verificato (vale per tutti)
	}
	...
	public void testIncrementalPairs() {
		...
		assertThrows(IllegalStateException.class, ()->outParser.accept(new Pair<>(5,List.of("a","a","a","a", "a"))));
	}
}
